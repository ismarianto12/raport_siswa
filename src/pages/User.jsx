                        ...
                        <div className="table-responsive">
                            <table className="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face1.jpg" alt="image" />
                                        </td>
                                        <td>
                                            Herman Beck
                                        </td>
                                    ...
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face2.jpg" alt="image" />
                                        </td>
                                        <td>
                                            Messsy Adam
                                        </td>
                                    ...
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face3.jpg" alt="image" />
                                        </td>
                                        <td>
                                            John Richards
                                        </td>
                                    ...
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face4.jpg" alt="image" />
                                        </td>
                                        <td>
                                            Peter Meggik
                                        </td>
                                    ...
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face5.jpg" alt="image" />
                                        </td>
                                        <td>
                                            Edward
                                        </td>
                                    ...
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face6.jpg" alt="image" />
                                        </td>
                                        <td>
                                            John Doe
                                        </td>
                                    ...
                                    <tr>
                                        <td className="py-1">
                                            <img src="https://www.bootstrapdash.com/demo/skydash/template/images/faces/face7.jpg" alt="image" />
                                        </td>
                                        <td>
                                            Henry Tom
                                        </td>
